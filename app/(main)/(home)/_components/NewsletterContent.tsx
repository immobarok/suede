    ...
    >
      ...
      >
        ...
        <RippleButton
          ...
          rippleColor="#000000"
          duration="700ms"
          className="group mx-auto cursor-pointer rounded-full border-0 bg-white px-8 py-5 text-sm font-medium tracking-[0.15em] text-black uppercase transition-all duration-300 hover:bg-white/90"
        >
          {copy.button}
        </RippleButton>
      </motion.form>
