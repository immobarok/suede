        ...
        <div className="grid gap-12 border-t border-black/15 pt-10 lg:grid-cols-[0.9fr_1.35fr] lg:gap-12">
          ...
          >
            <div>
              ...
              <p className="font-cormorant text-[24px] leading-normal font-normal text-black">
                <span className="italic">noun.</span> A softened leather, brushed to reveal
                its inner texture. Considered, tactile, quiet in its luxury.
              </p>
            </div>
            ...
            <div className="border-t border-black/15 pt-8">
              ...
              <p className="font-cormorant text-[24px] leading-normal font-normal text-black">
                <span className="italic">Verb.</span> To be moved toward something because of
                what you know, not what you were told.
              </p>
            </div>
          </motion.div>
          ...
          >
            <p className="font-cormorant text-[24px] leading-normal font-normal text-black">
              {content?.body || (
                <>
                  ...
                  <span className="font-semibold italic text-black/90">
                    chosen with intention
                  </span>{" "}
                  - worn by those who notice the difference, who value craft over
                  churn. And a small act of persuasion, the kind that happens when
                  you
            ...
            <p className="font-cormorant text-[24px] leading-normal font-normal text-black">
              ...
              Not by a headline, not by a trend cycle, not by a stranger whose body is
              nothing like yours. By evidence. By someone you share a silhouette with,
              who bought the thing, wore it, and told the truth.
            </p>
